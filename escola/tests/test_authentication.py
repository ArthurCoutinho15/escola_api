...
class AuthenticantionUserTestCase(APITestCase):
    def setUp(self):
    ...
    def test_autenticacao_credenciais_com_username_incorreto(self):
        """
    ...
    def test_autenticacao_credenciais_com_password_incorreto(self):
        """
